 ...
 * @property extensions - RegExp to match asset file extensions for preloading. Default: woff2? | ttf | otf | midi? | ogg | mp3 | png | jpe?g | gif | svg | webp | mp4 | webm
 */
 ...
 *
 * @param options - Configuration for asset size and file extensions.
...
export default function autoPreload(
  ...
  return {
    ...
    transformIndexHtml(html?: string, ctx?: IndexHtmlTransformContext) {
      ...
      // Additionl lookup for assets in HTML
